...
import { customerItem } from '../../../public/allData'
const Customer = () => {
  return (
    <div className='bg-blackClr py-[50px] opacity-95' style={{backgroundImage : `url(${customerImg})`}}>
        <Container>
              ...
              {customerItem?.map((customer, index) => (
                <FadeIn key={index} delay={(index + 1) * 0.3} direction="up">
                  ...
                  <img
                      ...
                      alt=""
                    />
                    <h1 className='text-[40px] md:text-[45px] lg:text-[64px] font-bold text-whiteClr mx-auto text-center'>{customer.count}</h1>
