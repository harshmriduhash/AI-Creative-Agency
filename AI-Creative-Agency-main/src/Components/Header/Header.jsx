      ...
      <Container>
        <div className="flex justify-between items-center">
          ...
          <button className="lg:hidden block mr-6" onClick={handleNavbar}>
                        ...
                        <HiBars3BottomRight className="text-whiteClr" size={28}></HiBars3BottomRight>
                </button>
        </div>
            {/* for mobile tablet devices  */}
      <div className={navOpen ? "py-0 block fixed z-20" : "py-0 hidden fixed  z-30"}>
      <div className="h-screen  z-[999] top-0  fixed  bg-black bg-opacity-50" onClick={handleNavbar}>
        <div className="bg-blackClr w-[380px] top-0 left-0 z-[99999] h-screen fixed">
            <div className="flex items-center px-5 h-14 top-4 right-0 absolute">
               <button className="flex items-center z-50  space-x-3" onClick={handleNavbar}>
               {/* <GrClose size={28} className=" mr-6 text-whiteClr"/> */}
